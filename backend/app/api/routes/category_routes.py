...
from app.repositories.exceptions import CategoryNotFoundError, DuplicateCategoryError, InvalidCategoryPositionError
...
def update_category(
    ...
    try:
        ...
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail="Category already exists") from exc
    except InvalidCategoryPositionError as exc:
        raise HTTPException(status_code=status.HTTP_400_BAD_REQUEST, detail="Invalid category position") from exc
