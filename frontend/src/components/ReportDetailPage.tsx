...
import { useCategoriesQuery, useCreateFilterMutation } from "../services/categories/queries";
...
function ReportSections({ report, onFilterClick, onCreateFilter, selectedFilterId }: ReportSectionsProps): JSX.Element {
    ...
    return (
        <>
            ...
            {hasUnidentified ? (
                <UnidentifiedSection transactions={report.unidentifiedTransactions} onCreateFilter={onCreateFilter} />
            ) : null}
        </>
    );
}
