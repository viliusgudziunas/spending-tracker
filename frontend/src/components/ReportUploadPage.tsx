...
export default function ReportUploadPage(): JSX.Element {
    ...
    return (
        <div className="min-h-screen bg-slate-100 p-5">
            <div className="mx-auto grid max-w-[1400px] grid-cols-1 gap-4 lg:grid-cols-[300px_1fr]">
                <aside className="sticky top-4 flex h-fit flex-col gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
                    <h2 className="m-0 text-lg font-semibold text-slate-900">Upload</h2>
                    <p className="m-0 text-xs text-slate-500">Select CSV and create report.</p>
                ...
                <div className="flex flex-col gap-3">
                    <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
                        <h1 className="m-0 text-2xl font-semibold text-slate-900">Report Upload Preview</h1>
                    </div>
